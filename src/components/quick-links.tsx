...
export const QuickLink = ({ title, description, tags = noop, href, date }: Props) => (
    <div className="group relative rounded-xl border bg-white dark:bg-primary-darker shadow border-slate-200 dark:border-slate-800">
        <div className="absolute -inset-px rounded-xl border-2 border-transparent opacity-0 duration-300 ease-in-out [background:linear-gradient(var(--quick-links-hover-bg,theme(colors.green.50)),var(--quick-links-hover-bg,theme(colors.green.50)))_padding-box,linear-gradient(to_top,theme(colors.primary.darkest),theme(colors.glow.left),theme(colors.primary.btn))_border-box] group-hover:opacity-100 motion-safe:transition-all dark:[--quick-links-hover-bg:theme(colors.green.800)]" />
